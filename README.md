...
localhost:
  Reponse Headers:
    HTTP/1.1 200 OK
    Date: Mon, 25 Sep 2023 11:17:57 GMT
...
favicon.ico
  Reponse Headers:
    HTTP/1.1 200 OK
    Date: Mon, 25 Sep 2023 11:17:58 GMT
    keep-alive: timeout=5
    Transfer-Encoding: chunked
...
localhost:
  Reponse Headers:
    ...
    Date: Mon, 25 Sep 2023 11:20:09 GMT
    keep-alive: timeout=5
...
La réponse reçue par le client contient:
localhost:
  Reponse Headers:
    HTTP/1.1 200 OK
    Content-Type: text/html
    Date: Mon, 25 Sep 2023 11:22:33 GMT
...
L'erreur affichée dans la console est la suivante errno: -4058.
...
Les deux commandes ci-dessus nous ont permis de régler le problème de définitions des variables d'environment entre différents système, mais aussi d'installer nodemon qui va nous permettre de recharge le serveur et la page à chaque changement dans le script.
...
Ce sont les environnement de de l'application. `http-dev` représente l'environnement de développement de l'application. Le second `http-prod` représente son environnement de production.
